...
| File | Content |
|---|---|
| 01-introduction | Project origin, objectives and background |
| 02-description | Features, UI/UX and use cases |
| 03-installation | Step-by-step setup guide |
| 04-style-guide | Colours, typography and Figma prototype |
| 05-design | Architecture, ER diagram and API design |
| 06-development | Sprint sequence, decisions and code snippets |
| 07-testing | Testing methodology and results |
| 08-deployment | GitHub Pages and Docker deployment |
| 09-user-manual | End-user guide with FAQs |
| 10-conclusions | Evaluation, lessons learned and future work |
